    ...
    public partial class first_migration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CashBalance", x => x.id);
                    table.ForeignKey(
                        name: "FK_CashBalance_Branches_BranchId",
                        column: x => x.BranchId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StoreOwners_Branches_BranchId",
                        column: x => x.BranchId,
                        principalTable: "Branches",
                        principalColumn: "BranchId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrdersMedicine", x => new { x.MedicineId, x.OrderId });
                    table.ForeignKey(
                        name: "FK_OrdersMedicine_Medicines_MedicineId",
                        column: x => x.MedicineId,
                        principalTable: "Medicines",
                        principalColumn: "MedicineId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OrdersMedicine_Orders_OrderId",
                        column: x => x.OrderId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrdersMedicine_OrderId",
                table: "OrdersMedicine",
                column: "OrderId");

            migrationBuilder.CreateIndex(
                name: "IX_StoreOwners_BranchId",
                table: "StoreOwners",
                column: "BranchId");
        }
